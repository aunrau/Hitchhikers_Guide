...
class PlanetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create planet" do
    assert_difference('Planet.count') do
      post planets_url, params: { planet: { location: @planet.location, planet: @planet.planet } }
    end
  ...
  test "should update planet" do
    patch planet_url(@planet), params: { planet: { location: @planet.location, planet: @planet.planet } }
